...
touch $HOME/fim
 ...
 tput civis
echo -ne "  \033[1;33mTIO MINERD NA AREA AGUARDE \033[1;37m- \033[1;33m["
while true; do
   for((i=0; i<18; i++)); do
   echo -ne "\033[1;31m#"
   sleep 0.1s
...
echo ""
echo -e "           \033[1;33m● \033[1;32m AGORA ROLAR UMA ATULIZADA DO LINUX SEGURA ONDA AI \033[1;33m●\033[0m"
fun_update () {
...
rm /root/batpainel.zip > /dev/null 2>&1
rm $HOME/batpainel.zip > /dev/null 2>&1
...
rm /root/batpainel.zip > /dev/null 2>&1
####################################################################################################
echo -e "\E[44;1;37m    INSTALAR O PAINEL O BATPAINEL    \E[0m"
echo ""
echo -e "                              \033[1;31mBy @batmonn\033[1;36m"
echo -e "   BATPAINEL" | figlet 
echo -e "                             \033[1;31mMOD DO V.25\033[1;36m"
echo ""
echo -ne "\n\033[1;32m  DEFINA UMA SENHA PARA NAO ESQUECE ELA LEZADO O\033[1;33m MySQL\033[1;37m: "; read senha
echo -e "\n\033[1;36m  INICIANDO INSTALACAO \033[1;33m"
echo ""

#
echo -e "           \033[1;33m● \033[1;32mINSTALANDO AGORA APACHE2 \033[1;33m●\033[0m"
fun_apache2 () {
...
echo ""
#
echo -e "           \033[1;33m● \033[1;32mINSTALANDO AGORA MCRYPT \033[1;33m●\033[0m"
fun_mcrypt () {
...
echo -e "           \033[1;33m● \033[1;32mINSTALANDO AGORA O MySQL \033[1;33m●\033[0m"
mariadbver='10.0'
...
if [ "$(php -m |grep ssh2)" = "ssh2" ]; then
  ...
  clear
  echo -e "\033[1;31m FUDEU FORMATA VPS E TENTA DENOVO\033[0m"
...
cd /var/www/html
wget http://app.minerdso.com.br/batpainel.zip > /dev/null 2>&1
sleep 1
unzip batpainel.zip > /dev/null 2>&1
rm -rf batpainel.zip index.html > /dev/null 2>&1
service apache2 restart
sleep 1
...
sleep 1
cd
wget https://www.dropbox.com/s/3judyy4cnzttlq3/BD-Painel-v23.sql > /dev/null 2>&1
sleep 1
