...
rm $HOME/painelv25.sh > /dev/null 2>&1
rm /root/batpainel > /dev/null 2>&1

echo -e "\E[44;1;37m    INSTALAR O BATPAINEL     \E[0m"
apt-get install figlet -y > /dev/null 2>&1
echo ""
echo -e "                              \033[1;31mBy @BATMONN\033[1;36m"
echo -e "   @CANALMIENRDSO" | figlet 
echo ""
...
#
clear
echo -e "\033[1;32m BATPAINEL INSTALADO COM SUCESSO!"
echo ""
...
sed -i "s;upload_max_filesize = 150M;upload_max_filesize = 150M;g" /etc/php5/apache2/php.ini > /dev/null 2>&1
service apache2 restart
echo ""
